...
class CIFAR10Albumentation:
    ...
    def train_transform(self, mean, std, max_holes=1, min_holes=1, max_height=16, min_height=16,
     max_width=16, min_width=16, cutout_prob=0.5):
        ...
        train_transforms = A.Compose([A.PadIfNeeded(min_height=40, min_width=40, always_apply=True),
                                      ...
                                      A.CoarseDropout(max_holes=max_holes,min_holes=min_holes,
                                      max_height=max_height, max_width=max_width, p=cutout_prob,
