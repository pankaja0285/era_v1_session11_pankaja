...
class TriggerEngine:
    ...
    def find_lr(self, model, train_loader, test_loader, start_lr, end_lr, plot_lr=False):
        ...
        print(f"plot_lr: {plot_lr}")
        if plot_lr:
            res = lr_finder.plot(suggest_lr=True, skip_start=0, skip_end=0)
